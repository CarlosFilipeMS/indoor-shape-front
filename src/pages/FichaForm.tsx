...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const fichaResponse = await axios.post("https://1d21-177-37-171-220.ngrok-free.app/fichas", {
      ...formData,
    ...
    const response = await axios.post(`https://1d21-177-37-171-220.ngrok-free.app/pagamento/criar-preferencia/${fichaId}`);
